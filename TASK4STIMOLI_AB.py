...
plt.suptitle('Grafico delle frequenze assolute rispetto al task 4 dicotomico',font_weight='bold',size=16)
plt.title(' _AB===>(Foto neutra a dx ||  Foto con stimolo a sx)',size=10)
plt.legend(loc="best")
