...
#PRIM0 TASK
plt.bar(str(durr[0]), sum_f1[0], width=0.3,color=colors[0],label="Prima visione del task")
plt.bar(str(durr[2]), sum_f1[1], width=0.3,color=colors[0])
plt.bar(str(durr[4]), sum_f1[1], width=0.3,color=colors[0])
plt.bar(str(durr[6]), sum_f1[2], width=0.3,color=colors[0])


plt.bar(str(durr[8]), sum_f2[0], width=0.3,color=colors[1],label="Seconda visione del task")
plt.bar(str(durr[10]), sum_f2[1], width=0.3,color=colors[1])
plt.bar(str(durr[12]), sum_f2[2], width=0.3,color=colors[1])
plt.bar(str(durr[14]), sum_f2[3], width=0.3,color=colors[1])
...
plt.xlabel('Intervalli di durata ')
